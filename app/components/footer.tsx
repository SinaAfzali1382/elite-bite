    ...
    <footer className="footer">
      ...
      <div className="footer-container">
        <div className="footer-section">
          <h3>لوگوی شرکت</h3>
          <p>ارائه‌دهنده راه‌حل‌های نوآورانه در فناوری و خدمات. با ما ارتباط برقرار کنید تا آینده خود را متحول کنید。</p>
        </div>
        <div className="footer-section">
          <h3>لینک‌های سریع</h3>
          <ul>
        ...
        <div className="footer-section newsletter">
          <h3>به‌روز بمانید</h3>
          <p>برای دریافت آخرین به‌روزرسانی‌ها در خبرنامه ما اشتراک کنید。</p>
        ...
        <div className="footer-section">
          ...
          <div className="social-icons">
            <a href="https://www.facebook.com/" target="_blank" title="فیس‌بوک">
              <img
                alt="فیس‌بوک"
                width="24"
                height="24"
            ...
            <a href="https://twitter.com" target="_blank" title="توییتر">
              <img
                alt="توییتر"
                width="24"
                height="24"
